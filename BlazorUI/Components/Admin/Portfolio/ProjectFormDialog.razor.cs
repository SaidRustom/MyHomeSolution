...
public partial class ProjectFormDialog
{
    ...
    [Parameter]
    public UpsertProjectRequest Model { get; set; } = new();
    ...
    string SubmitText => IsEdit ? "Save Changes" : "Add Project";
    ...
    async Task OnSubmitAsync()
    {
        ...
        var result = await PortfolioAdminService.UpsertProjectAsync(Model);
        ...
        if (result.IsSuccess)
        {
            Notifications.Notify(new NotificationMessage
            {
                ...
                Summary = IsEdit ? "Project Updated" : "Project Added",
                Detail = $"'{Model.Title}' has been saved.",
                Duration = 4000
            });
